...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DropDownList id="ddKlassen" runat="server" DataSourceID="SqlDataSource1" DataTextField="K_ID" DataValueField="K_ID">
    ...
    <!--<asp:ListView ID="ListView1" runat="server" DataKeyNames="K_ID" DataSourceID="SqlDataSource1" GroupItemCount="3">
        <AlternatingItemTemplate>
            <tr>
                ...
                <asp:Label ID="K_IDLabel" runat="server" Text='<# Eval("K_ID") %>' />   <!-- das erste Prozentzeichen gelöscht --> <!--
                    <br />
                </td>
            </tr>
        </AlternatingItemTemplate>
        <EditItemTemplate>
            <td runat="server" style="background-color: #FFCC66; color: #000080;">K_ID:
                <asp:Label ID="K_IDLabel1" runat="server" Text='<# Eval("K_ID") %>' />   <!-- das erste Prozentzeichen gelöscht --> <!--
                <br />
        ...
        <InsertItemTemplate>
            <td runat="server" style="">K_ID:
                <asp:TextBox ID="K_IDTextBox" runat="server" Text='<# Bind("K_ID") %>' />   <!-- das erste Prozentzeichen gelöscht --> <!--
                <br />
